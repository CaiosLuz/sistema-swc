    ...
    <div class="wrapper">
        ...
        <div class="nav-menu" id="navMenu">
            <ul>
                ...
                <li><a href="./estatistica.php" class="link active">Estatísticas</a></li>
        ...
        <div class="home-content">
            ...
            <script>
                ...
                async function fetchData(range) {
                    const response = await fetch(`../controller/consumoAguaController.php?action=consumoPeriodo&range=${range}`);
